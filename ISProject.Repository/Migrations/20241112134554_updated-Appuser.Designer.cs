...
namespace ISProject.Repository.Migrations
{
    ...
    [Migration("20241112134554_updated-Appuser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISProject.Domain.Identity.MusicStoreUser", b =>
                {
            ...
            modelBuilder.Entity("ISProject.Domain.MusicRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ISProject.Domain.Order", b =>
                {
                    b.HasOne("ISProject.Domain.Identity.MusicStoreUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ISProject.Domain.ShoppingCart", b =>
                {
                    b.HasOne("ISProject.Domain.Identity.MusicStoreUser", "Owner")
                        .WithOne("UserCart")
                        .HasForeignKey("ISProject.Domain.ShoppingCart", "OwnerId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ISProject.Domain.Identity.MusicStoreUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ISProject.Domain.MusicRecord", b =>
                {
                    b.Navigation("MusicRecordInOrders");

                    b.Navigation("MusicRecordsInShoppingCart");
                });

            modelBuilder.Entity("ISProject.Domain.Order", b =>
                {
                    b.Navigation("MusicRecordsInOrder");
                });
